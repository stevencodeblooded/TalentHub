  ...
  return (
    <div>
        ...
        <div className="flex items-center justify-between py-4">
            ...
            {
                mobileLinks && (
                    <ul className="absolute top-0 left-0 z-10 w-full min-h-screen bg-gray-700 flex flex-col items-center justify-center gap-8 text-white text-sm md:hidden">
                        ...
                        <li><NavLink onClick={() => setMobileLinks(false)} to={'/signup'}>Join Us</NavLink></li>
                        <button  className="bg-green-500 hover:bg-green-600 transition-all font-semibold py-3 w-5/6 text-center rounded-3xl mt-10" onClick={() => setMobileLinks(false)} >Join Us</button>
                    </ul>
                )
            }
